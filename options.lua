...
--Options
local function ABConf(bars, extraBarStart, extraBars)
	for i = 1, bars do
		local name = L['Bar '] .. i
			...
			args = {
				enable = {
					...
					set = function(info, value)
						E.db.actionbar.combatstate['bar' .. i]['enable'] = value
						ABCS:MouseOverOption(i)
						ABCS:SettingsUpdate(i)
						ABCS:LeavingCombat(true, i)
					end,
				},
				fullAlphaOnMouseOver = {
					...
					set = function(info, value)
						E.db.actionbar.combatstate['bar' .. i]['fullAlphaOnMouseOver'] = value
						ABCS:UpdateHooks('bar' .. i)
					end,
				},
				ic = {
					order = 3,
				...
				ooc = {
					...
					set = function(info, value)
						E.db.actionbar.combatstate['bar' .. i]['ooc'][info[#info]] = value
						ABCS:LeavingCombat()
					end,
					args = {
						intro = {
	...
	if extraBarStart and extraBars then
	...
	E.Options.args.actionbar.args.combatstate.args.barPet = {
		...
		args = {
			enable = {
				...
				set = function(info, value)
					E.db.actionbar.combatstate.barPet['enable'] = value
					ABCS:MouseOverOption('pet')
					ABCS:SettingsUpdate('pet')
					ABCS:LeavingCombat(true, 'pet')
				end,
			},
			fullAlphaOnMouseOver = {
				order = 2,
				...
				set = function(info, value)
					E.db.actionbar.combatstate['barPet']['fullAlphaOnMouseOver'] = value
					ABCS:UpdateHooks('barPet')
				end,
			},
			ic = {
				order = 3,
			...
			ooc = {
				...
				args = {
					...
					mouseover = {
						...
						desc = L['The frame is not shown unless you mouse over the frame.'],
						set = function(info, value)
							E.db.actionbar.combatstate.barPet['ooc']['mouseover'] = value
							ABCS:LeavingCombat()
						end,
					},
					alpha = {
						...
						step = 0.01,
						set = function(info, value)
							E.db.actionbar.combatstate.barPet['ooc']['alpha'] = value
							ABCS:LeavingCombat()
						end,
					},
					visibility = {
	...
	E.Options.args.actionbar.args.combatstate.args.stanceBar = {
		...
		args = {
			enable = {
				...
				set = function(info, value)
					E.db.actionbar.combatstate.stanceBar['enable'] = value
					ABCS:MouseOverOption('stance')
					ABCS:SettingsUpdate('stance')
					ABCS:LeavingCombat(true, 'stance')
				end,
			},
			fullAlphaOnMouseOver = {
				order = 2,
				...
				set = function(info, value)
					E.db.actionbar.combatstate['stanceBar']['fullAlphaOnMouseOver'] = value
					ABCS:UpdateHooks('stanceBar')
				end,
			},
			ic = {
				order = 3,
			...
			ooc = {
				...
				args = {
					...
					mouseover = {
						...
						desc = L['The frame is not shown unless you mouse over the frame.'],
						set = function(info, value)
							E.db.actionbar.combatstate.stanceBar['ooc']['mouseover'] = value
							ABCS:LeavingCombat()
						end,
					},
					alpha = {
						...
						step = 0.01,
						set = function(info, value)
							E.db.actionbar.combatstate.stanceBar['ooc']['alpha'] = value
							ABCS:LeavingCombat()
						end,
					},
				},
...
function ABCS:GetOptions()
	E.Options.args.actionbar.args.combatstate = {
		...
		args = {
			...
			globalForceAlpha = {
				...
				set = function(info, value)
					E.private.combatstate.GlobalFullAlpha = value
	...
	ABConf(bars, extraBarStart, extraBars)
end
